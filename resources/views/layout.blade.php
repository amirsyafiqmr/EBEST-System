...
*********************************************************************************************************************************************************** -->
    ...
    <header class="header black-bg">
        ...
        <!--logo start-->
        <a href="/custMain" class="logo"><b><span>E-BEST</span> SYSTEM</b></a>
        <!--logo end-->
        ...
        <div id="sidebar" class="nav-collapse ">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{ route('bookHome') }}" class="nav-link {{ (request()->is('/view/booking')) ? 'active show-sub' : '' }}">Create Booking</a></li>
                        <li><a href="{{ route('viewBooking', Auth::guard('customer')->user()->cust_id) }}" class="nav-link {{ (request()->is('/viewBooking/*')) ? 'active show-sub' : '' }}">View Booking</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="{{route('equipViewCustomer') }}" class="nav-link {{ (request()->is('equipView')) ? 'active show-sub' : '' }}">
                ...
                <li class="sub-menu">
                    <a href="{{ route('custView', Auth::guard('customer')->user()->cust_id) }}" class="nav-link {{ (request()->is('custViewAcc/*')) ? 'active show-sub' : '' }}">
                ...
                <li class="sub-menu">
                    <a class="btn btn-success btn-sm ml-3" href="{{route('cart.checkout')}}">
                        <i class="fa fa-shopping-cart" ></i> List Quantity Booked
