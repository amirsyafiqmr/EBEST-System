                ...
                <div class="card-body">
                    @isset($url)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <label class="form-check-inline"><input type="radio" name="designation" value="admin">Admin</label>
                                <label class="form-check-inline"><input type="radio" name="designation" value="staff" checked>Staff</label>
                            </div>
                        </div>
